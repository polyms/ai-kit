...
Edit the right-hand column to match whatever vocabulary you actually use on GitHub/GitLab.

## GitHub labels (manual)

After `/setup` writes this file, create matching labels on the remote tracker. Example for GitHub:
...
Adjust colors and descriptions to taste. Labels must exist on the remote before triage can apply them.
