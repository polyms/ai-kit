...
- **Light mode:** ui-kit semantic tokens only — verify table borders and matrix gap cells meet AA.
...
- [x] Interactive elements map to ui-kit or custom table with follow-up
- [x] No invented names duplicating ui-kit primitives
- [x] Theme via ui-kit semantic tokens
- [ ] `/ui-kit` attached — **not this session**; flagged for `/dev`
